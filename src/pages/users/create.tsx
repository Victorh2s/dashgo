...
export default function CreateUser(){
    ...
    const createUser = useMutation(async (user: SignInData) => {
    ...
    const handleCreateUser: SubmitHandler<SignInData> = async (values) => {
                ...
                <Box as="form" flex="1" borderRadius={8} bg="gray.800" p={["6","8"]} onSubmit={handleSubmit(handleCreateUser)}>
                    ...
                    <VStack spacing="8">
                        ...
                        <SimpleGrid minChildWidth="240px" spacing={["6","8"]} w="100%">
                            ...
                            <Input type="password" label="Confirmação da senha" {...register('password_confirmation')} error={formState.errors.password_confirmation} />
                        </SimpleGrid>
                    </VStack>
